...
from .scheduler import ContinuousBatchScheduler, RequestScheduler
...
class ModelResourceSpec:
    ...
    def from_mapping(cls, data: dict[str, Any], default_features: RuntimeFeatures) -> "ModelResourceSpec":
        ...
        return cls(
            ...
            adapter_id=str(data.get("adapter_id", data.get("adapter", "qwen36"))),
...
class EngineResourcePolicy:
    ...
    QwenBurst currently targets one 16GB GPU, so the safe default is one loaded
...
class EngineManager:
    ...
    def summary(self) -> dict[str, Any]:
        return {
            ...
            "scheduler": self.scheduler.stats().summary(),
