...
from qwenburst.core.cuda_graph import CudaGraphBucketPlanner
from qwenburst.core.scheduler import ContinuousBatchScheduler, RequestScheduler


def test_request_scheduler_tracks_stats():
...
def test_request_scheduler_rejects_when_queue_is_full():
    scheduler = RequestScheduler(max_active_requests=1, max_queued_requests=0)
    with scheduler.acquire():
        try:
