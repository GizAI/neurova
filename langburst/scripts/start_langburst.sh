...
DECODE_PREFILL_INTERLEAVE_STEPS="${DECODE_PREFILL_INTERLEAVE_STEPS:-${LANGBURST_DECODE_PREFILL_INTERLEAVE_STEPS:-16}}"
BATCH_WAIT_MS="${BATCH_WAIT_MS:-${LANGBURST_BATCH_WAIT_MS:-8}}"
...
MAX_PREFILL_ROWS_PER_BATCH="${MAX_PREFILL_ROWS_PER_BATCH:-${LANGBURST_MAX_PREFILL_ROWS_PER_BATCH:-$MAX_ACTIVE_REQUESTS}}"
MAX_QUEUED_REQUESTS="${MAX_QUEUED_REQUESTS:-${LANGBURST_MAX_QUEUED_REQUESTS:-8}}"
MAX_STATE_POOL_SIZE="${MAX_STATE_POOL_SIZE:-${LANGBURST_MAX_STATE_POOL_SIZE:-$MAX_ACTIVE_REQUESTS}}"
MAX_GENERATION_TOKENS="${MAX_GENERATION_TOKENS:-${LANGBURST_MAX_GENERATION_TOKENS:-8192}}"
...
if ! ss -ltn | grep -q ":${SERVER_PORT} "; then
  nohup env \
    ...
    LANGBURST_MARLIN_OUT_CACHE_POLICY="${LANGBURST_MARLIN_OUT_CACHE_POLICY:-decode_only}" \
    LANGBURST_MARLIN_DIRECT_MAX_BATCH="${LANGBURST_MARLIN_DIRECT_MAX_BATCH:-256}" \
    LANGBURST_MTP_MAX_DRAFT="${LANGBURST_MTP_MAX_DRAFT:-1}" \
    LANGBURST_MTP_DRAFT_CANDIDATES="${LANGBURST_MTP_DRAFT_CANDIDATES:-1}" \
    ...
    LANGBURST_DEFAULT_MAX_TOKENS="${LANGBURST_DEFAULT_MAX_TOKENS:-$MAX_GENERATION_TOKENS}" \
    ...
    LANGBURST_PREFIX_CACHE_MIN_FREE_MIB="${LANGBURST_PREFIX_CACHE_MIN_FREE_MIB:-384}" \
