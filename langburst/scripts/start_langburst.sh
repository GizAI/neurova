...
ENABLE_MTP="${ENABLE_MTP:-${LANGBURST_ENABLE_MTP:-0}}"
MTP_SPECULATIVE_TOKENS="${MTP_SPECULATIVE_TOKENS:-${LANGBURST_MTP_SPECULATIVE_TOKENS:-1}}"
CONTEXT_WINDOW="${CONTEXT_WINDOW:-${LANGBURST_CONTEXT_WINDOW:-${RECENT_WINDOW:-49152}}}"
...
if ! ss -ltn | grep -q ":${SERVER_PORT} "; then
  nohup env \
    ...
    LANGBURST_SHORT_PREFILL_SDPA_TOKENS="${LANGBURST_SHORT_PREFILL_SDPA_TOKENS:-4096}" \
    ...
    LANGBURST_MARLIN_OUT_CACHE_POLICY="${LANGBURST_MARLIN_OUT_CACHE_POLICY:-off}" \
