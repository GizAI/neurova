...
CONTEXT_WINDOW="${CONTEXT_WINDOW:-${LANGBURST_CONTEXT_WINDOW:-${RECENT_WINDOW:-32768}}}"
...
PREFILL_CHUNK_SIZE="${PREFILL_CHUNK_SIZE:-${LANGBURST_PREFILL_CHUNK_SIZE:-512}}"
MAX_NUM_BATCHED_TOKENS="${MAX_NUM_BATCHED_TOKENS:-${LANGBURST_MAX_NUM_BATCHED_TOKENS:-$PREFILL_CHUNK_SIZE}}"
...
MAX_ACTIVE_REQUESTS="${MAX_ACTIVE_REQUESTS:-${LANGBURST_MAX_ACTIVE_REQUESTS:-2}}"
...
MAX_STATE_POOL_SIZE="${MAX_STATE_POOL_SIZE:-${LANGBURST_MAX_STATE_POOL_SIZE:-$MAX_ACTIVE_REQUESTS}}"
...
if ! ss -ltn | grep -q ":${SERVER_PORT} "; then
  nohup env \
    ...
    LANGBURST_ATTENTION_RECENT_TOKENS="${LANGBURST_ATTENTION_RECENT_TOKENS:-8192}" \
