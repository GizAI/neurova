...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("gdn_recurrent_ab_spec_trajectory", &gdn_recurrent_ab_spec_trajectory,
        "Speculative Qwen-style gated delta scan over [B,T] returning per-token state trajectory",
        py::arg("q"),
        py::arg("k"),
        py::arg("v"),
        py::arg("a"),
        ...
        py::arg("state_arena"),
        py::arg("state_indices"));
  m.def("gdn_recurrent_ab_spec_trajectory_out", &gdn_recurrent_ab_spec_trajectory_out,
        "Speculative Qwen-style gated delta scan over [B,T] into preallocated out/trajectory buffers",
        py::arg("q"),
        py::arg("k"),
        py::arg("v"),
        py::arg("a"),
  ...
  m.def("depthwise_conv_update_batch", &depthwise_conv_update_batch,
        ...
        py::arg("weight"),
        py::arg("bias"));
  m.def("depthwise_conv_update_spec", &depthwise_conv_update_spec,
        "Speculative causal depthwise conv scan over [B,T] with commit-token state update",
        py::arg("state_arena"),
        py::arg("state_indices"),
        py::arg("commit_tokens"),
        py::arg("x"),
        py::arg("weight"),
        py::arg("bias"));
  m.def("depthwise_conv_update_spec_trajectory", &depthwise_conv_update_spec_trajectory,
        "Speculative causal depthwise conv scan over [B,T] returning per-token state trajectory",
        py::arg("state_arena"),
        py::arg("state_indices"),
        py::arg("x"),
        py::arg("weight"),
        py::arg("bias"));
  m.def("depthwise_conv_update_spec_trajectory_out", &depthwise_conv_update_spec_trajectory_out,
        "Speculative causal depthwise conv scan over [B,T] into preallocated out/trajectory buffers",
        py::arg("state_arena"),
        py::arg("state_indices"),
        py::arg("x"),
        py::arg("weight"),
  ...
  m.def("attention_decode_paged_fp16", &attention_decode_paged_fp16,
        ...
        py::arg("block_size"),
        py::arg("softmax_scale"));
  m.def("attention_decode_paged_fp8_e4m3", &attention_decode_paged_fp8_e4m3,
        "Batched fp8_e4m3 decode attention over paged KV block table",
        py::arg("q"),
        py::arg("k_new"),
        py::arg("v_new"),
        py::arg("k_pages"),
        ...
        py::arg("k_scale"),
        py::arg("v_scale"));
  m.def("attention_append_paged_int4", &attention_append_paged_int4,
        "Batched INT4/BDR append-only paged KV update",
        py::arg("k_new"),
        py::arg("v_new"),
        py::arg("k_pages"),
        py::arg("v_pages"),
  ...
  m.def("attention_append_paged_int4_spec", &attention_append_paged_int4_spec,
        "Speculative INT4/BDR paged KV append over [B,T] with commit-token gating",
        py::arg("k_new"),
        py::arg("v_new"),
        py::arg("k_pages"),
        py::arg("v_pages"),
        ...
        py::arg("rotate_v"),
        py::arg("tiled_layout") = false);
  m.def("attention_spec_decode_paged_int4", &attention_spec_decode_paged_int4,
        "Speculative INT4/BDR paged attention over live prefix plus [B,T] candidate KV without live writes",
        py::arg("q"),
        py::arg("k_new"),
        py::arg("v_new"),
        py::arg("k_pages"),
  ...
  m.def("resolve_greedy_speculative", &resolve_greedy_speculative,
        "Resolve greedy speculative decisions on GPU",
        py::arg("draft_token_ids"),
        py::arg("target_token_ids"),
        py::arg("bonus_token_ids"),
        py::arg("cu_num_draft_tokens"),
        py::arg("scheduled_token_counts"));
}
