...
void attention_append_paged_int4(torch::Tensor k_new, torch::Tensor v_new, torch::Tensor k_pages, torch::Tensor v_pages, torch::Tensor k_scales, torch::Tensor v_scales, torch::Tensor k_zeros, torch::Tensor v_zeros, torch::Tensor slot_mapping, int64_t block_size, int64_t hadamard_order, bool bdr_k, bool rotate_v);
