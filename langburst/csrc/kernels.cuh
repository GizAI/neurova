...
std::vector<torch::Tensor> gdn_recurrent_ab_spec_trajectory_norm_gate(torch::Tensor q, torch::Tensor k, torch::Tensor v, torch::Tensor a, torch::Tensor b, torch::Tensor A_log, torch::Tensor dt_bias, torch::Tensor state_arena, torch::Tensor state_indices, torch::Tensor norm_w, torch::Tensor z, double eps);
void gdn_recurrent_ab_spec_trajectory_norm_gate_out(torch::Tensor q, torch::Tensor k, torch::Tensor v, torch::Tensor a, torch::Tensor b, torch::Tensor A_log, torch::Tensor dt_bias, torch::Tensor state_arena, torch::Tensor state_indices, torch::Tensor norm_w, torch::Tensor z, torch::Tensor out, torch::Tensor trajectory, double eps);
void copy_selected_trajectory_out(torch::Tensor trajectory, torch::Tensor dest, torch::Tensor state_indices, torch::Tensor commit_tokens);
