...
The current `mamba3` path is a runnable Mamba-3 MIMO prototype, not a capable LLM yet.
...
5. Train with the 2K -> 8K -> 32K -> 128K long-state curriculum in `neuromamba/configs/mamba3_english_curriculum.json`.
