...
DEVICE="${DEVICE:-cuda}"
DTYPE="${DTYPE:-bf16}"
TRAIN_DATA="${TRAIN_DATA:-neuromamba/data/splits/base_general_recovery_strat_train.txt}"
VALID_DATA="${VALID_DATA:-neuromamba/data/splits/base_general_recovery_strat_valid.txt}"
RUN_ROOT="${RUN_ROOT:-neuromamba/runs/mamba3_arch_context_compare}"
