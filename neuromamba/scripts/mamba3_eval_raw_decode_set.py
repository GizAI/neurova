...
from neuromamba.cli import _fast_decode_once, load_or_new
...
def main() -> None:
    ...
    parser.add_argument("--out", type=Path, default=Path("neuromamba/runs/mamba3_clean_doc_base_moe24_v1/raw_decode_set/latest.jsonl"))
