...
def main() -> None:
    ...
    parser.add_argument("--data", type=Path, default=Path("neuromamba/data/mamba3_programmatic_curriculum.jsonl"))
    parser.add_argument("--limit", type=int, default=64)
    parser.add_argument("--mode", default="mimo-r4-tiny")
    parser.add_argument("--tokenizer", default="llama31")
    parser.add_argument("--checkpoint", type=Path, default=Path("neuromamba/runs/mamba3_tiny/model_mimo_r4_speak.pt"))
