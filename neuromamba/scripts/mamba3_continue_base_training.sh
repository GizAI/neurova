...
DEVICE="${DEVICE:-cuda}"
DTYPE="${DTYPE:-bf16}"
BASE_DATA="${BASE_DATA:-neuromamba/data/splits/base_first_train.txt}"
VALID_DATA="${VALID_DATA:-neuromamba/data/splits/base_first_valid.txt}"
START_CHECKPOINT="${START_CHECKPOINT:-neuromamba/runs/mamba3_recall_r2_base_first_v1/base.pt}"
CHECKPOINT="${CHECKPOINT:-neuromamba/runs/mamba3_recall_r2_base_first_v1/base_long.pt}"
...
payload = {
    ...
    "base_data": os.environ.get("BASE_DATA", "neuromamba/data/splits/base_first_train.txt"),
    "valid_data": os.environ.get("VALID_DATA", "neuromamba/data/splits/base_first_valid.txt"),
    "start_checkpoint": os.environ.get("START_CHECKPOINT", "neuromamba/runs/mamba3_recall_r2_base_first_v1/base.pt"),
    "checkpoint": os.environ.get("CHECKPOINT", "neuromamba/runs/mamba3_recall_r2_base_first_v1/base_long.pt"),
}
try:
