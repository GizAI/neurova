...
DEVICE="${DEVICE:-cuda}"
DTYPE="${DTYPE:-bf16}"
RUN_ROOT="${RUN_ROOT:-neuromamba/runs/mamba3_stability_ladder}"
PROGRAMMATIC_DATA="${PROGRAMMATIC_DATA:-neuromamba/data/mamba3_programmatic_curriculum_ladder.jsonl}"
...
for mode in "${MODES[@]}"; do
  ...
  CUDA_GRAPH="${CUDA_GRAPH}" \
    neuromamba/scripts/mamba3_train_scientific_tiny.sh || {
