...
RUN_DIR="${RUN_DIR:-${ROOT}/neuromamba/runs/mamba3_siso_fast_0_3b_ds128_no_cheat_knowledge_v1}"
...
neuromamba/scripts/mamba3_exclusive_gpu_guard.sh run neuromamba/scripts/mamba3_train_0_3b_no_cheat_knowledge_v1.sh
EOF
