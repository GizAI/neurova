...
LOCAL_MAMBA = ROOT / "neuromamba" / "vendor" / "mamba"
if LOCAL_MAMBA.exists() and str(LOCAL_MAMBA) not in sys.path:
    sys.path.insert(0, str(LOCAL_MAMBA))

from mamba_ssm.utils.generation import InferenceParams
from neuromamba.cli import _fast_decode_once, load_or_new, setup_perf
from neuromamba.scripts.mamba3_safe_chat import (
    clean_answer,
