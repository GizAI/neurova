...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", type=Path, default=Path("neuromamba/runs/mamba3_neurova_speak_v1/sft.pt"))
    ...
    parser.add_argument("--out", type=Path, default=Path("neuromamba/runs/mamba3_neurova_speak_v1/decode_tune/latest.json"))
