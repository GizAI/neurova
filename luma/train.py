...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--qwen-tokenizer-path", default="tokenizers/qwen35")
    p.add_argument("--bytepatch-vocab-path", default="tokenizers/luma_bytepatch/bytepatch_vocab.json")
