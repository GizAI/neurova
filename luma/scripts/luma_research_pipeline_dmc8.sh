...
STAGE1="${STAGE1:-luma/runs/luma_stage1_qwen_natural_pre_v1}"
STAGE2="${STAGE2:-luma/runs/luma_stage2_qwen_chat_sft_v1}"
STAGE3="${STAGE3:-luma/runs/luma_stage3_qwen_slotproof_v1}"
STAGE1_RAW_DATA="${STAGE1_RAW_DATA:-luma/data/luma_stage_doc_cont_v1.jsonl}"
if [[ ! -f "${STAGE1_RAW_DATA}" ]]; then
  STAGE1_RAW_DATA=luma/data/luma_stage_raw_cont_v2.jsonl
fi
