...
RUN_DIR="${RUN_DIR:-runs/luma_memory_proof_v1}"
...
RAW_DATA="${RAW_DATA-data/luma_stage_raw_cont_v1.jsonl}"
QA_DATA="${QA_DATA:-}"
CHAT_DATA="${CHAT_DATA-data/luma_stage_chatml_sft_v1.jsonl}"
MEMORY_DATA="${MEMORY_DATA-data/luma_stage_chatml_memory_v1.jsonl}"
SEQ_LEN="${SEQ_LEN:-512}"
...
QWEN_TOKENIZER_PATH="${QWEN_TOKENIZER_PATH:-tokenizers/qwen35}"
BYTEPATCH_VOCAB_PATH="${BYTEPATCH_VOCAB_PATH:-tokenizers/luma_bytepatch/bytepatch_vocab.json}"
...
print(json.dumps({
    ...
    "raw_data": os.environ.get("RAW_DATA", "data/splits/base_doc_cont_train.txt"),
    "qa_data": os.environ.get("QA_DATA", ""),
    "chat_data": os.environ.get("CHAT_DATA", "data/neurova_chat_sft_v1.jsonl"),
    "memory_data": os.environ.get("MEMORY_DATA", "data/luma_memory_curriculum_v1.jsonl"),
    ...
    "bytepatch_vocab_path": os.environ.get("BYTEPATCH_VOCAB_PATH", "tokenizers/luma_bytepatch/bytepatch_vocab.json"),
