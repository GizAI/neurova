...
CONFIG="${CONFIG:-${ROOT}/configs/mamba3_corpus_sources.json}"
MAX_DOCS="${MAX_DOCS:-3000}"
MAX_BYTES="${MAX_BYTES:-200000000}"
MIN_CHARS="${MIN_CHARS:-300}"
OUT="${OUT:-data/luma_stage_doc_cont_v1.jsonl}"
...
python -m luma.analyze_training_data \
  ...
  --out data/luma_language_corpus_analysis_v1.json
