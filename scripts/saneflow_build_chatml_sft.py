...
def main() -> None:
    ...
    parser.add_argument("--recipe", type=Path, default=Path("configs/saneflow_chatml_sft_recipe.json"))
    parser.add_argument("--train-out", type=Path, default=Path("data/corpus/mixes/saneflow_chatml_sft_train_v1.jsonl"))
    parser.add_argument("--valid-out", type=Path, default=Path("data/corpus/mixes/saneflow_chatml_sft_valid_v1.jsonl"))
    parser.add_argument("--manifest-out", type=Path, default=Path("data/corpus/mixes/saneflow_chatml_sft_manifest_v1.json"))
