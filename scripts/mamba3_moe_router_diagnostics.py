...
from mamba3_kr.data import iter_packed_token_batches
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data", nargs="+", type=Path, default=[Path("data/splits/base_doc_cont_v3_valid.jsonl")])
    parser.add_argument("--out", type=Path, default=Path("runs/mamba3_clean_doc_base_moe24_v1/router_diagnostics/latest.json"))
