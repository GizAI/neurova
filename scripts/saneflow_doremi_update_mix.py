...
def main() -> None:
    ...
    parser.add_argument("--source-losses", type=Path, default=Path("data/corpus/mixes/saneflow_practical_pretrain_v1/source_losses.json"))
    parser.add_argument("--reference-losses", type=Path, default=None)
    parser.add_argument("--out", type=Path, default=Path("data/corpus/mixes/saneflow_practical_pretrain_v1/doremi_ratios.json"))
