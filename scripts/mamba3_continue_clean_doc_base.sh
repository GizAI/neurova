...
TRAIN_DATA="${TRAIN_DATA:-data/splits/base_doc_cont_v3_train.jsonl}"
VALID_DATA="${VALID_DATA:-data/splits/base_doc_cont_v3_valid.jsonl}"
...
python scripts/mamba3_validate_doc_continuation_split.py "${TRAIN_DATA}" "${VALID_DATA}" >/dev/null
...
payload = {
    ...
    "checkpoint": os.environ.get("CHECKPOINT", "runs/mamba3_clean_doc_base_moe900_v1/base.pt"),
    "train_data": os.environ.get("TRAIN_DATA", "data/splits/base_doc_cont_v3_train.jsonl"),
    "valid_data": os.environ.get("VALID_DATA", "data/splits/base_doc_cont_v3_valid.jsonl"),
