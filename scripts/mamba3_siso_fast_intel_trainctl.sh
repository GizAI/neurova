...
RUN_DIR="${RUN_DIR:-${ROOT}/runs/mamba3_siso_fast_0_3b_ds128_intel_v1}"
...
export START_CHECKPOINT="${START_CHECKPOINT:-runs/mamba3_siso_fast_0_3b_ds128_v3/model.pt}"
export BASE_DATA="${BASE_DATA:-data/splits/base_doc_cont_v3_train.jsonl}"
...
scripts/mamba3_exclusive_gpu_guard.sh run scripts/mamba3_train_siso_fast_0_3b_intel_v1.sh
EOF
