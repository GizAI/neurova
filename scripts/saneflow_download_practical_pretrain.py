...
def main() -> None:
    ...
    parser.add_argument("--recipe", type=Path, default=Path("configs/saneflow_practical_pretrain_sources.json"))
    ...
    out = Path("data/corpus/sources/practical_pretrain_manifest_v1.json")
