...
CONTROL_ROOT="${CONTROL_ROOT:-${ROOT}/runs/mamba3_autonomous_hybrid_research/control}"
LOG_ROOT="${LOG_ROOT:-${ROOT}/runs/mamba3_autonomous_hybrid_research/logs}"
...
case "${1:-status}" in
  start)
    ...
    run_root="${RUN_ROOT:-${ROOT}/runs/mamba3_autonomous_hybrid_research/${stamp}}"
...
exec scripts/mamba3_exclusive_gpu_guard.sh run scripts/mamba3_autonomous_hybrid_research_loop.sh
EOF
