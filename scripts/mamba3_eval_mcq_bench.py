...
from mamba3_kr.cli import load_or_new, setup_perf  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint", type=Path, default=Path("runs/mamba3_siso_fast_0_3b_ds128_v3/model.pt"))
    ...
    parser.add_argument("--out", type=Path, default=Path("runs/mamba3_benchmarks/latest_mcq.json"))
