...
| `neurova.sh` | Launcher | — |
| `neurova/docs/ARCHITECTURE_v6.md` | This file | — |
| `neurova/scripts/deploy_v6.sh` | ml-dmc8 deploy | — |
...
# Specific user
V6_USER=alice python3 neurova/v6.py

# Thinking mode
V6_EFFORT=mid python3 neurova/v6.py
