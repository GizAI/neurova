#!/usr/bin/env python3
"""
Neurova V41 CLI — Language Acquisition Engine (Clean).
...
try:
    from neurova.v41_language_acquisition import NeurovaEngine
except ImportError:
...
def main():
    histfile = os.path.join(os.path.expanduser("~"), ".neurova_v41_history")
    try:
    ...
    print("=" * 58)
    print("  Neurova V41 — Language Acquisition Engine")
